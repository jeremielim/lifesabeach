...
public class Pickup : MonoBehaviour
{
    ...
    //         GameObject.Find("DialogManager").GetComponent<DialogManager>().state_can();
    //     }
    //     // DoCollision(other);
    // }
    ...
    // {
    //     GameObject.Find("DialogManager").GetComponent<DialogManager>().state_empty();
    // }
    

    protected virtual void DoCollision(Collider other)
    {
